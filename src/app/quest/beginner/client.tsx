...
const STEPS = [
  {
    ...
    result: "Инструмент выбран под твою задачу. Node.js и GitHub готовы.",
  },
  {
...
}checklist: ["Прочитай обзор выше и выбери свой инструмент", "Новичок → Vibecraft (русский, без VPN, бесплатно)", "Есть опыт → Cursor или VS Code + Copilot", "Всем: установи Node.js (nodejs.org, LTS)", "Всем: зарегистрируйся на github.com"]"use client";
