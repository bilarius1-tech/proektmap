...
const STEPS = [
  {
    ...
    detail: "Для AI-разработки нужен редактор кода со встроенным ИИ. Вот все топовые варианты — выбирай под свою задачу.

🇷🇺 Российские (без VPN, русский язык):
• Vibecraft (vibe.sourcecraft.dev) — пишешь идею → получаешь сайт. No-code, лучший для новичков. Бесплатно.
• SourceCraft (sourcecraft.dev) — GitHub-подобный хостинг + AI-ассистент. Нужен Yandex ID.
• GigaCode (gigacode.ru) — аналог Copilot от Сбера. Для VS Code и JetBrains.

🌍 Международные:
• Cursor (cursor.com) — лучший AI-редактор. $20/мес, но есть бесплатный тир. Требуется зарубежная карта.
• VS Code + GitHub Copilot — бесплатный редактор + AI-расширение ($10/мес).
• Reasonix (reasonix.ai) — open-source AI-агент в терминале. Бесплатно. Для продвинутых.

⚡ Что ещё нужно:
• Node.js (nodejs.org, версия LTS) — движок для JavaScript.
• GitHub (github.com) — облачное хранилище кода. Бесплатно.",
    checklist: [
    ...
    why: "Российские сервисы (Vibecraft, SourceCraft, GigaCode) работают без VPN и принимают российские карты. Международные (Cursor, Copilot) мощнее, но требуют оплату зарубежной картой. Node.js нужен всем. GitHub — бесплатное облако для кода.",
