...
export const avitoTools: AvitoTool[] = [
  ...
  },
  {
    ...
    types: ["Расширение"],
    categories: ["extensions"],
    description: "Скрывает объявления и продавцов из чёрного списка прямо в выдаче.",
    price: "Бесплатно",
    website: "https://chromewebstore.google.com/detail/jhobdoodiicgomhcmcdapbdehndbhkfj",
    status: "active",
    lastChecked: "2026-08-21",
    api: "none",
    risk: false,
  },
  {
    ...
    types: ["Расширение"],
    categories: ["extensions", "avitolog"],
  ...
  // ── Автопостинг / desktop ─────────────────────────────────
  {
    ...
    categories: ["autoposting", "avitolog", "analytics"],
    description:
      "Десктопная программа для Windows: массово размещает, редактирует, продлевает, поднимает и удаляет объявления; клонирует по городам и аккаунтам; шаблоны, уникализация текста и фото, расписание, Excel/XML, прокси и статистика. Для больших объёмов и нескольких кабинетов.",
  ...
  },
  {
    ...
    categories: ["autoposting", "integrations"],
    description:
      "Помощник для официальной «Автозагрузки» Авито: конвертирует таблицы (XLSX и др.) в XML, который принимает площадка, и готовит архивы с изображениями. Сам по себе не публикует — работает только вместе со штатной Автозагрузкой на тарифе «Расширенный» или «Максимальный».",
  ...
  },
  {
    ...
    categories: ["autoposting", "integrations"],
    description:
      "Официальный инструмент площадки: публикация и обновление объявлений по расписанию из XML, CSV или Excel. Не сторонний сервис. Утилиты вроде Av-Poster лишь готовят файл, который загружает само Авито.",
  ...
  },
  {
    ...
    name: "Calltouch",
    types: ["SaaS"],
    categories: ["analytics", "integrations"],
