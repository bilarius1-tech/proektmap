...
export const avitoTools: AvitoTool[] = [
  ...
  // ── Автопостинг / desktop ─────────────────────────────────
  {
    ...
    description: "Массовый постинг, редактирование и продление объявлений, Excel/XML, работа с несколькими аккаунтами.",
    price: "разовая лицензия ≈ от 8 900 ₽",
  ...
  },
  {
    ...
    name: "Av-Poster",
    types: ["Desktop"],
    categories: ["autoposting"],
    description: "Пакетная выгрузка объявлений в разделы Авито и автоматизация рутинных действий.",
    price: "от 500 ₽/мес",
  ...
  {
    slug: "avito-autoload",
    name: "Автопостинг Авито",
    types: ["Web"],
    categories: ["autoposting", "integrations"],
    description: "Официальная массовая загрузка из XML/CSV/Excel, расписание и управление объявлениями от самой площадки.",
    price: "по тарифам Авито Pro",
