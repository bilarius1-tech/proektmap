...
export default async function SandboxPage() {
  ...
  const cards = [
    ...
    { slug: "creative-library", title: "Креативная библиотека", desc: "GSAP, Three.js, Phaser, Spline, Rive — 15 инструментов для необычных проектов. Карточка + промпт для AI-агента.", icon: Library, size: "large" as const, stat: "15", statLabel: "инструментов MVP", href: "/sandbox/creative-library" },
